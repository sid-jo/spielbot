...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your board game rules assistant — grounded in official rulebooks and BoardGameGeek community discussions." },
      { name: "author", content: "SpielBot" },
      { property: "og:title", content: "SpielBot — Board Game Rules Assistant" },
      { property: "og:description", content: "Grounded answers for Catan, Splendor, and Root rules questions." },
